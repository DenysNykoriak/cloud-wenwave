...
resource "aws_lambda_permission" "cognito_invoke_pre_sign_up" {
  ...
  function_name = module.server-generated-lambdas.cognito_pre_sign_up_lambda_arn
...
resource "aws_lambda_permission" "cognito_invoke_post_auth" {
  statement_id  = "AllowCognitoInvoke"
  action        = "lambda:InvokeFunction"
  function_name = module.server-generated-lambdas.cognito_post_auth_lambda_arn
  principal     = "cognito-idp.amazonaws.com"
  source_arn    = aws_cognito_user_pool.dashboard_user_pool.arn
}
...
resource "aws_lambda_permission" "api_gateway_invoke_lambda" {
  ...
  action        = "lambda:InvokeFunction"
  function_name = module.server-generated-lambdas.user_me_lambda_arn
